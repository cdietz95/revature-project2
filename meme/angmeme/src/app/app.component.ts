...
export class AppComponent {
  ...
  pics = [this.url.concat('test/tmry7yys3f3w6tyzxj6a.png'), this.url.concat('test/nsdk5rlwelowxvocycdx.png'), this.url.concat('test/vqefmdlwgrxrpgbo3u2l.gif'),
    this.url.concat('test/efeh0npwyekchwhjcgbs.png'), this.url.concat('test/ij5qk3hbobgjwno45gxo.gif'),
...
//this is where we would send info to the database
// fetch("localhost:8080/post-api/post",{
//   method: 'GET',
//   // headers: {
...
//   caption: (<HTMLInputElement>document.getElementById('caption')).value,
